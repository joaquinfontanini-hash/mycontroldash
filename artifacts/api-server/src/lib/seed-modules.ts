...
const DEFAULT_MODULES = [
  ...
  { key: "fitness", name: "Actividad Física", description: "Plan de entrenamiento, nutrición y diario de comidas personal", allowedRoles: ["super_admin", "admin", "editor", "viewer"], orderIndex: 22 },
];
